...
{
    0x47,0x49,0x46,0x38,0x39,0x61,0x10,0x95,0x10,0x95,0xf2,0x95,0x95,0x95,0x95,0x95,
    0x95,0x95,0x86,0x95,0x95,0xff,0x86,0x95,0x95,0xff,0x95,0x95,0x86,0x82,0x86,0xcc,
    0xcc,0xcc,0x95,0x95,0x95,0x21,0xf9,0x04,0x01,0x95,0x95,0x06,0x95,0x2c,0x95,0x95,
    0x95,0x95,0x10,0x95,0x10,0x95,0x95,0x03,0x43,0x68,0xba,0xdc,0x6e,0x22,0x3e,0x16,
    0x6b,0x99,0xb0,0xc6,0xfb,0x44,0xf0,0x45,0xa8,0x09,0xcc,0x17,0x84,0x4a,0xa0,0x9e,
    0x9c,0x89,0xa6,0x95,0xbb,0xac,0xdc,0x12,0xd6,0x06,0xcd,0x10,0xbc,0xb3,0x32,0x83,
    0xe0,0xa0,0xa1,0x8a,0x2d,0x06,0x95,0xe4,0x90,0x11,0x6b,0x06,0x0c,0xb7,0xd7,0xc2,
    0x09,0xc0,0x3d,0x0a,0x80,0xac,0x75,0x72,0xc3,0x78,0x17,0x09,0x95,0x3b
};
...
/*****************************************************************/
static const unsigned char CHRtab[256] =
{
  0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x0d,0x95,0x95,
  ...
  0x70,0x71,0x72,0x73,0x74,0x75,0x76,0x77,0x78,0x79,0x7a,0x5c,0xA3,0x5d,0x20,0x20,
  ...
  // 0x80-0xFF
  0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x0a,0x95,0x95,
  0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,0x95,
    ...
    if (fileName.endsWith(".mus"))
    {
        ...
        if (QFile::exists(wdsFileName))
        {
            ...
            if (wdsFile.open(QIODevice::ReadOnly))
            {
                ...
                {
                    data[i] = CHRtab[static_cast<unsigned char>(data.at(i))];
                }
